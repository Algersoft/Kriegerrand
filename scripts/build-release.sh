...
function usage()
{
    ...
    echo "and generates the checksum files of the kriegerrand tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/AlgerSoft/kriegerrand.git"
CLONE_DIR="$BUILD_DIRECTORY/kriegerrand-buildall"
TARGET_DIR="$BUILD_DIRECTORY/kriegerrand-releases"
DYNAMIC_RELEASE="kriegerrand-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="kriegerrand-${TAG_VERSION}-linux-staticboost-CLI"
