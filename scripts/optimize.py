# USAGE: Start krieger-api as you usually would
...
from kriegerrand import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="KriegerBank address to optimize", required=True)
